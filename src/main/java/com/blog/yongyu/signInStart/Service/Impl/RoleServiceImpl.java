...
import com.blog.yongyu.signInStart.Repository.RoleRepository;
    ...
    public List<JSONObject> findAll() throws FriendlyException {
        ...
        for (int i=0; i<all.size(); i++) {
            ...
            if (!tmp.equals(r.getUserType()) || i + 1 == all.size()) {
                ...
                jsonObject.put("userType", tmp);
                jsonObject.put("userTypeName", tmp.equals(BaseSetting.ROLE.SupperAdmin_SYS.toString()) ? "超级管理员" :
